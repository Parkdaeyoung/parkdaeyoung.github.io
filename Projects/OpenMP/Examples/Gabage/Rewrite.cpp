...
//			llvm::outs() << ss.str() << "\n";
		...
		bool VisitOMPTargetDirective(OMPTargetDirective *D) {
			 ...
			 * Body
			 */
			_Rewriter.InsertTextBefore(Body->getBeginLoc(), BeginStr.str());
//			Body->printPretty(ss, nullptr, Policy, 1);
			...
			EndStr << "\n}\n";
			_Rewriter.InsertTextAfter(Body->getEndLoc(), EndStr.str());
//			Body->printPretty(ss, nullptr, Policy, 1);
...
//			_Rewriter.RemoveText(SourceRange(BeginLoc, EndLoc));
			return true;
		}
